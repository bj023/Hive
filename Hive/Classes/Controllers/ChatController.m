...
- (void)refreshDataWithMessageID:(NSString *)msgID
{
    ...
    dispatch_async(_messageQueue, ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            [weakSelf.tableView scrollToRowAtIndexPath:[NSIndexPath indexPathForRow:[weakSelf.mesgaeArr count]-1 inSection:0] atScrollPosition:UITableViewScrollPositionBottom animated:YES];
        });
    });
}
